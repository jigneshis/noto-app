...
// import { Button } from '@/components/ui/button'; // No longer needed for login button
// import { useAuth } from '@/contexts/auth-context'; // Removed
// import { UserNav } from '@/components/user-nav'; // Removed
// import { LogIn } from 'lucide-react'; // Removed
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center">
        <Link href="/" className="mr-4 flex items-center space-x-2">
          ...
          {/* <span className="font-bold text-xl text-foreground">NOTO</span> Removed as text is in Logo SVG */}
